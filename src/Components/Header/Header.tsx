...
function Header() {
    ...
    return (
        ...
        // style={{display: 'none'}} 
        className={
            nav ? [styles.drawer, styles.active].join(' ') : [styles.drawer]
            }>
            <div 
             style={{padding:'13px 15px'}}
             className={styles.drawerBlock1}>
               ...
               <Image height={32} width={32} src="/assets/User,Profile.svg" alt="logo" />
            ...
            <div style={{paddingTop:'20px', paddingBottom:'20px', paddingLeft:'15px', }}
             className={styles.drawerBlock2}>
                <div style={{marginBottom:'20px'}} className={styles.geo}>
                            <div style={{marginRight:'10px'}} className={styles.geoLogo}>
                                <Image height={32} width={32} src="/assets/Group.svg" alt="logo" />
                            </div>
                        ...
                        <div style={{marginBottom:'20px'}} className={styles.phone}>
                            ...
                            <div style={{marginRight:'10px'}} className={styles.phoneLogo}>
                                <Image height={32} width={32} src="/assets/Phone.svg" alt="logo" />
                            </div>
                            <div className={styles.phoneText}>+7 (347) 229-46-45</div>
                        </div>
                        
                            <Link style={{display: 'flex', alignItems: "center"}} href='/basket'>
                 
                    <div className={styles.basketIcon}>
                        <Image height={34} width={34} src="/assets/basket1.svg" alt="logo" />
                    </div>
                    ...
                    <div className={styles.nav}>
                        <div className={styles.geo}>
                            <div className={styles.geoLogo}>
                                <Image width={25} height={25} src="/assets/Group.svg" alt="logo" />
                            </div>
                            <div className={styles.geoText}>Пятигорск</div>
                        </div>
                        <Link href='/basket' className={styles.basket11}>
                          <Image width={25} height={25} src="/assets/basket1.svg" alt="logo" />
                        </Link>
                        <div className={styles.phone}>
                            <div className={styles.phoneLogo}>
                               
                               <Image width={25} height={25} src="/assets/Phone.svg" alt="logo" />
                        ...
                        <div className={styles.user}>
                            <div className={styles.userLogo}>
                                ...
                                <Image width={25} height={25} src="/assets/User,Profile.svg" alt="logo" />
                                </Link>
                                
                            </div>
                            <div className={styles.userText}><Link href='/login'>Вход</Link> / <Link href='/registration'>Регистрация</Link></div>
                        </div>
                    </div>
